...
public class LessMetricsTest {
  ...
  public void project_measures() {
    ...
    assertThat(getProjectMeasure("comment_lines_density").getValue()).isEqualTo(19.4);
  ...
  public void dir_measures() {
    ...
    assertThat(getDirMeasure("comment_lines").getIntValue()).isEqualTo(5);
    assertThat(getDirMeasure("comment_lines_density").getValue()).isEqualTo(22.7);
  ...
  public void file2_measures() {
    ...
    assertThat(getFile2Measure("comment_lines").getIntValue()).isEqualTo(5);
    assertThat(getFile2Measure("comment_lines_density").getValue()).isEqualTo(22.7);
  ...
  private Measure getFile1Measure(String metricKey) {
    return getFileMeasure(metricKey, PROJECT_KEY + ":src/file1.less");
  }

  private Measure getFile2Measure(String metricKey) {
    return getFileMeasure(metricKey, PROJECT_KEY + ":src/dir/file2.less");
  }

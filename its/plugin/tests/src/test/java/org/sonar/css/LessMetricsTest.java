...
public class LessMetricsTest {

  @ClassRule
  public static Orchestrator orchestrator = Tests.ORCHESTRATOR;

  private static final String PROJECT_KEY = "less-metrics";
  ...
  public static void init() {
    ...
    SonarScanner build = Tests.createSonarScannerBuild()
      .setProjectDir(new File("../projects/less-metrics/"))
  ...
  public void project_measures() {
    assertThat(getProjectMeasure("lines")).isEqualTo(46);
    ...
    assertThat(getProjectMeasure("comment_lines")).isEqualTo(7);
    assertThat(getProjectMeasure("comment_lines_density")).isEqualTo(19.4);
  ...
  public void dir_measures() {
    assertThat(getDirMeasure("lines")).isEqualTo(28);
    ...
    assertThat(getDirMeasure("comment_lines")).isEqualTo(5);
    assertThat(getDirMeasure("comment_lines_density")).isEqualTo(22.7);
  ...
  public void file2_measures() {
    assertThat(getFile2Measure("lines")).isEqualTo(28);
    ...
    assertThat(getFile2Measure("comment_lines")).isEqualTo(5);
    assertThat(getFile2Measure("comment_lines_density")).isEqualTo(22.7);

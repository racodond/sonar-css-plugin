...
public class CssMetricsTest {
  ...
  public void project_measures() {
    ...
    assertThat(getProjectMeasure("comment_lines_density")).isEqualTo(17.1);
  ...
  public void dir_measures() {
    ...
    assertThat(getDirMeasure("comment_lines")).isEqualTo(4);
    assertThat(getDirMeasure("comment_lines_density")).isEqualTo(19.0);
  ...
  public void file2_measures() {
    ...
    assertThat(getFile2Measure("comment_lines")).isEqualTo(4);
    assertThat(getFile2Measure("comment_lines_density")).isEqualTo(19.0);

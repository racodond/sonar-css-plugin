...
public class LessDuplicationsTest {
  ...
  public void project_measures() {
    assertThat(getProjectMeasure("duplicated_lines").getIntValue()).isEqualTo(43);
    ...
    assertThat(getProjectMeasure("duplicated_lines_density").getValue()).isEqualTo(95.6);
  }

  @Test
  public void dir_measures() {
    assertThat(getDirMeasure("duplicated_lines").getIntValue()).isEqualTo(14);
  ...
  public void file1_measures() {
    assertThat(getFile1Measure("duplicated_lines").getIntValue()).isEqualTo(29);
    assertThat(getFile1Measure("duplicated_blocks").getIntValue()).isEqualTo(2);
    assertThat(getFile1Measure("duplicated_lines_density").getValue()).isEqualTo(93.5);
  }

  @Test
  public void file2_measures() {
    assertThat(getFile2Measure("duplicated_lines").getIntValue()).isEqualTo(14);

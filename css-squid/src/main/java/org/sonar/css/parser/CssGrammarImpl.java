...
public enum CssGrammarImpl implements GrammarRuleKey {
	...
	stylesheet, statement, atRule, block, ruleset, selector, declaration, property, value, any, unused,

	ident, atkeyword, string, bad_string, bad_uri, bad_comment, hash, number, percentage, dimension, uri, unicodeRange, cdo, cdc,

	colon, semiColon, lCurlyBracket, rCurlyBracket, lParenthesis, rParenthesis, lBracket, rBracket,

	whiteSpace, whiteSpaces, comment, function, includes, dashMatch, delim,

	_ident, _name, _nmstart, _nonascii, _unicode, _escape, _nmchar, _num, _string, _string1, _string2, _badString, _badString1, _badString2, _badcomment, _badcomment1, _badcomment2, _baduri, _baduri1, _baduri2, _baduri3, _nl, _w,
	...
	private static void syntax(LexerlessGrammarBuilder b) {
		...
		b.rule(block).is(
				lCurlyBracket,
				whiteSpaces,
				b.zeroOrMore(b.firstOf(any, block,
						b.sequence(atkeyword, whiteSpaces),
						b.sequence(semiColon, whiteSpaces))), rCurlyBracket,
				whiteSpaces);
		b.rule(ruleset).is(
				b.optional(selector),
				lCurlyBracket,
		...
		b.rule(value).is(
				b.oneOrMore(b.firstOf(any, block,
						b.sequence(atkeyword, whiteSpaces))));
		b.rule(any)
				.is(b.firstOf(ident, number, percentage, dimension, string,
						delim, uri, hash, unicodeRange, includes, dashMatch,
						colon, b.sequence(function, whiteSpaces,
								b.zeroOrMore(/* b.firstOf( */any/*
																 * , unused )
																 */),
								rParenthesis), b.sequence(lParenthesis,
								whiteSpaces,
								b.zeroOrMore(/* b.firstOf( */any/*
																 * , unused )
																 */),
								rParenthesis), b.sequence(lBracket,
								whiteSpaces,
								b.zeroOrMore(/* b.firstOf( */any/*
																 * , unused )
																 */), rBracket)),

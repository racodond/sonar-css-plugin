...
public class ScssParentReferencingSelectorTreeTest extends ScssTreeTest {

  public ScssParentReferencingSelectorTreeTest() {
    super(LexicalGrammar.SCSS_PARENT_REFERENCING_SELECTOR);
  }

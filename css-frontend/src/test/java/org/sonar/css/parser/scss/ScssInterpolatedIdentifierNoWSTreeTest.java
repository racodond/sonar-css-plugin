...
public class ScssInterpolatedIdentifierNoWSTreeTest extends ScssTreeTest {

  public ScssInterpolatedIdentifierNoWSTreeTest() {
    super(LexicalGrammar.SCSS_INTERPOLATED_IDENTIFIER_NO_WS);
  }

  @Test
  public void scssInterpolatedIdentifierNoWS() {
    checkParsed("#{$class}");
    checkParsed("#{$cla-ss}");
    checkParsed("#{$cla_ss}");
    checkParsed("#{$cla0ss}");
  ...
  @Test
  public void notScssInterpolatedIdentifierNoWS() {
    checkNotParsed("*");
    checkNotParsed("abc");
    checkNotParsed(".");

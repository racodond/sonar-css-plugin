...
public class PropertyTreeTest extends ScssTreeTest {
  ...
  public void property() {
    ...
    assertThat(tree.isHacked()).isFalse();
    assertThat(tree.property().isScssInterpolated()).isFalse();
    ...
    assertThat(tree.property().isScssInterpolated()).isTrue();

...
public class CustomScssRulesDefinitionTest {
  ...
  public static class MyCustomScssRulesDefinition extends CustomScssRulesDefinition {
    ...
    public Class[] checkClasses() {
      return new Class[]{CustomScssRulesDefinitionTest.MyCustomRule.class};
    }
  }

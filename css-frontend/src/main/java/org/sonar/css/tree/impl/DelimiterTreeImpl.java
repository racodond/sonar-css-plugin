...
public class DelimiterTreeImpl extends LiteralTreeImpl implements DelimiterTree {

  public DelimiterTreeImpl(SyntaxToken delimiter) {
    super(delimiter);
  }

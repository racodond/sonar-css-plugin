...
public class ImportantFlagTreeImpl extends TreeImpl implements ImportantFlagTree {

  private final SyntaxToken exclamationMark;
  private final SyntaxToken importantKeyWord;

  public ImportantFlagTreeImpl(SyntaxToken exclamationMark, SyntaxToken importantKeyWord) {

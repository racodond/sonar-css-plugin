...
public class ScssIfTreeImpl extends ScssConditionalDirectiveTreeImpl implements ScssIfTree {

  public ScssIfTreeImpl(SyntaxToken directive, ScssConditionTree condition, StatementBlockTree block) {

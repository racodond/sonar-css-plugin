...
import org.sonar.css.tree.impl.embedded.CssInScriptTagsTreeImpl;
...
public class TreeFactory {
  ...
  public CssInScriptTagTree cssInScriptTag(SyntaxToken openingTag, StyleSheetTree styleSheet, SyntaxToken closingTag) {
    return new CssInScriptTagsTreeImpl(openingTag, styleSheet, closingTag);
  }

...
public class EmbeddedCssGrammar extends CssGrammar {
  ...
  public CssInScriptTagTree CSS_IN_SCRIPT_TAG() {
    return b.<CssInScriptTagTree>nonterminal(LexicalGrammar.CSS_IN_SCRIPT_TAG).is(
      f.cssInScriptTag(
        b.token(LexicalGrammar.OPENING_HTML_SCRIPT_TAG),
        STYLESHEET(),
        b.token(LexicalGrammar.CLOSING_HTML_SCRIPT_TAG)));
  }

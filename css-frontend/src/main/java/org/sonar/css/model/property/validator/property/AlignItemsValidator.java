...
public class AlignItemsValidator implements ValueValidator {
  ...
  public String getValidatorFormat() {
    return "normal | stretch | [ [first | last]? baseline ] | [ [unsafe | safe]? [center | start | end | self-start | self-end | flex-start | flex-end | left | right] ]";
  }

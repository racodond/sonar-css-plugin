...
@Rule(
  key = "quoted-url",
  name = "URL should be quoted",
  priority = Priority.MINOR,
  tags = {Tags.BROWSER_COMPATIBILITY})
@SqaleConstantRemediation("5min")
@ActivatedByDefault
public class QuotedUrlCheck extends DoubleDispatchVisitorCheck {

  @Override
  public void visitUriContent(UriContentTree tree) {
    if (tree.string() == null && !"".equals(tree.text())) {
      addPreciseIssue(tree, "Quote this URL.");
    }

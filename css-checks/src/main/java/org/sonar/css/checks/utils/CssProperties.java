...
public final class CssProperties {
  ...
  public static final ImmutableList<CssProperty> PROPERTIES = ImmutableList.of(
    ...
    new CssProperty("border-radius", ImmutableList.of("-webkit-"),
      new EnumValidator(ImmutableList.of("abc", "def"))),
    ...
    // new CssProperty("top"),
    new CssProperty("transform", ImmutableList.of("-webkit-", "-moz-", "-ms-", "-o-"),
      new EnumValidator(ImmutableList.of("abc", "def")))

...
public class GenerateValidatePropertyValueRuleDescription {

  public static void main(String... args) throws Exception{
    StringBuilder htmlPage = new StringBuilder();
    htmlPage.append("<p>Browsers ignore invalid property values. Review those invalid property values; either remove them if they are useless or update them.</p>\n");
    htmlPage.append("<h2>Noncompliant Code Example</h2>\n");
    htmlPage.append("<pre>\n");
    htmlPage.append("/* 'word-spacing' validator is 'normal | &lt;length&gt;' */\n");
    htmlPage.append(".mybox {\n");
    htmlPage.append("  word-spacing: 10px;\n");
    htmlPage.append("  word-spacing: normal;\n");
    htmlPage.append("  word-spacing: 0;\n");
    htmlPage.append("  word-spacing: inherit;\n");
    htmlPage.append("  word-spacing: 10;       /* Noncompliant: Missing length unit */\n");
    htmlPage.append("  word-spacing: abc;      /* Noncompliant: 'abc' value is not allowed */\n");
    htmlPage.append("}\n");
    htmlPage.append("</pre><h2>Implemented Checks</h2>\n");
    htmlPage
      .append(
      "<p>Based on <a target=\"_blank\" href=\"http://www.w3.org/Style/CSS/current-work\">W3C CSS specifications</a> Level 1 or 2 or 3 which status is either Completed or Testing or Refining.</p>\n");
    htmlPage.append("<table border=1>\n");
    htmlPage.append("  <thead>\n");
    htmlPage.append("  <tr align=center>\n");
    htmlPage.append("    <th>Name</th>\n");
    htmlPage.append("    <th>Validator</th>\n");
    htmlPage.append("  </tr>\n");
    htmlPage.append("  </thead>\n");
    ...
    while (it.hasNext()) {
      ...
      htmlPage.append("  <tr>\n");
      htmlPage.append("    <td nowrap=\"nowrap\">");
      if (property.getUrl() != null) {
        htmlPage.append("<a target=\"_blank\" href=\"");
        htmlPage.append(property.getUrl());
        htmlPage.append("\">");
      }
      ...
      htmlPage.append(property.getValidatorFormat()
        ...
        .replace("<line-style-position>",
          "<a target=\"_blank\" href=\"http://dev.w3.org/csswg/css-lists-3/#propdef-list-style-position\">&lt;line-style-image&gt;</a>")
        .replace("<line-style-image>",
          "<a target=\"_blank\" href=\"http://dev.w3.org/csswg/css-lists-3/#propdef-list-style-image\">&lt;line-style-position&gt;</a>")
        .replace("<line-style-type>",
          "<a target=\"_blank\" href=\"http://dev.w3.org/csswg/css-lists-3/#propdef-list-style-type\">&lt;line-style-type&gt;</a>")
    ...
    try {
      Writer writer = new BufferedWriter(
        new OutputStreamWriter(new FileOutputStream("css-checks/target/classes/org/sonar/l10n/css/rules/css/validate-property-value.html"),
          "utf-8"));
      //writer.write(htmlPage.toString()); To uncomment when http://jira.sonarsource.com/browse/SONAR-6632 is fixed
      writer.write("TO BE DONE");
      writer.close();
    } catch (IOException e) {
      throw new RuntimeException("Could not generate the Validate property value rule description.", e);
    }
  }

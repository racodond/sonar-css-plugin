...
public class GenerateValidatePropertyValueRuleDescription {
  ...
  public static void main(String... args) throws Exception {
    StringBuilder htmlPage = buildRuleHeader();
    // To be uncommented when http://jira.sonarsource.com/browse/SONAR-6632 is fixed
  ...
  private static StringBuilder buildRuleHeader() {
    return new StringBuilder()
      .append(
        "<p>Browsers ignore invalid property values. Review those invalid property values either remove them if they are useless or update them.</p>\n")

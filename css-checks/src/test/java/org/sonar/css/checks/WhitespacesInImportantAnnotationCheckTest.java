...
public class WhitespacesInImportantAnnotationCheckTest {

  private WhitespacesInImportantAnnotationCheck check = new WhitespacesInImportantAnnotationCheck();
  private final String MESSAGE = "Remove the whitespaces between \"!\" and \"important\".";

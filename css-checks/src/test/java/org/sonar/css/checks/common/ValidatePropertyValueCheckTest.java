...
public class ValidatePropertyValueCheckTest {
  ...
  public void test_number_of_validated_properties() {
    assertEquals(314, CheckTestUtils.getCommonTestFile("properties/css").listFiles().length);
    assertEquals(314, CheckTestUtils.getCommonTestFile("properties/less").listFiles().length);
    assertEquals(314, CheckTestUtils.getCommonTestFile("properties/scss").listFiles().length);
  }

...
public class ValidatePropertyValueCheckTest {
  ...
  public void test_number_of_validated_properties() {
    Assert.assertEquals(304, CheckTestUtils.getCommonTestFile("properties/css").listFiles().length);
    Assert.assertEquals(304, CheckTestUtils.getCommonTestFile("properties/less").listFiles().length);
    Assert.assertEquals(304, CheckTestUtils.getCommonTestFile("properties/scss").listFiles().length);
  }

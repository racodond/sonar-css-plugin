...
public class TabCharacterCheckTest {
  ...
  public void should_find_tab_characters_and_raise_an_issue() {
    CssCheckVerifier.verifyCssFile(check, CheckTestUtils.getCommonTestFile("tabcharacter.css"));
  }

  @Test
  public void should_not_find_tab_characters_and_not_raise_an_issue() {
    CssCheckVerifier.verifyCssFile(check, CheckTestUtils.getCommonTestFile("notabcharacter.css"));
  }
